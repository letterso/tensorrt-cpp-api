...
public:
    ...
    // Convert MONO to GPU and apply scaling and mean subtraction
    static cv::cuda::GpuMat bloFromMonoGpuMats(const std::vector<cv::cuda::GpuMat> &batchInput, const std::array<float, 3> &subVals, 
